  ...
  return c.html(
    <html>
      <head>
        ...
        <meta property="og:url" content="https://saavnapi.shanlaksh.space" />
        <meta property="og:title" content={title} />
        <meta property="og:description" content={description} />
        <meta property="twitter:card" content="summary_large_image" />
        <meta property="twitter:url" content="https://saavnapi.shanlaksh.space" />
        <meta property="twitter:title" content={title} />
        <meta property="twitter:description" content={description} />
        <meta
          property="og:image"
          content="https://raw.githubusercontent.com/mslaksh/saavn-api/main/assets/preview.jpg"
        />
        <meta
        ...
        <link
          rel="icon"
          type="image/x-icon"
          href="https://raw.githubusercontent.com/mslaksh/saavn-api/main/assets/favicon.ico"
        />
          ...
          <div class="grid grid-cols-1 sm:grid-cols-4 lg:grid-cols-4 xl:grid-cols-8 gap-2 sm:gap-0 relative grid-flow-row">
            ...
            <div class="p-4 sm:p-8 hover:bg-opacity-5 hover:bg-white rounded-lg duration-100 sm:col-span-4">
              <div class="flex flex-col">
                ...
                <span class="text-neutral-200 font-bold text-lg sm:text-xl md:text-2xl mt-2">Shanlaksh</span>
                <div class="text-neutral-500 mt-2">
                  Have a doubt or need help? Reach out on{' '}
                  <a
